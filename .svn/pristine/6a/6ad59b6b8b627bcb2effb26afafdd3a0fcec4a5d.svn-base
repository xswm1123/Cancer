...
@interface AddReportViewController : CommonViewController<UITextViewDelegate, UITextFieldDelegate>
...
@property(nonatomic, strong) IBOutlet NSLayoutConstraint *topConstraint;//最顶约束

@property(nonatomic, strong) IBOutlet NSLayoutConstraint *enterBtnRightConstraint;//确定按钮约束

@property(nonatomic, strong) IBOutlet NSLayoutConstraint *reportContentHeightConstraint;
...
@property(nonatomic, strong) NSString *contactsTitleName;
